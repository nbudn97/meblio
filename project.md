...
### 24.08.2026 — Новый логотип «Паз»
- Знак: две доски со смещением, соединённые шипом (столярное соединение) — метафора сделки и производства
- Инлайн-SVG в хедере, монохром #2563eb, hover затемнение, dark-вариант
- Favicon/PWA-иконки сгенерированы кодом: tools/gen_logo.py → meblio.png 64px, meblio-512.png (any+maskable), manifest обновлён
- SW v8
